...
public:
    ...
    Shader(const char *vertexPath, const char *fragmentPath)
    {
        ...
        {
            std::cout << "ERROR::SHADER::FILE_NOT_SUCCESSFULLY_READ: vertex shader file '" << vertexPath << "' could not be read" << std::endl;
        }
        ...
        {
            std::cout << "ERROR::SHADER::FILE_NOT_SUCCESSFULLY_READ: fragment shader file '" << fragmentPath << "' could not be read" << std::endl;
        }
